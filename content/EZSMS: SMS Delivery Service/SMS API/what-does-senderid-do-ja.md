...
[Kプレミアムサービス](https://help.xoxzo.com/ja/ezsms-sms-delivery-service/articles/what-is-k-premium/)をご利用になると、日本のau(KDDI)の携帯電話向けに、サービス申し込み時に設定した送信元IDを受信側へ表示させることができます。
お申込みを含めた詳細は、[Kプレミアムサービス](https://help.xoxzo.com/ja/ezsms-sms-delivery-service/articles/what-is-k-premium/)のページより、ご確認ください。
