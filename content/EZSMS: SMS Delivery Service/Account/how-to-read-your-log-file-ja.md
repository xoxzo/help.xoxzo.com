  ...
  <table border="1" cellpadding="1" cellspacing="1">
    <tbody>
      ...
      <tr>
        ...
        &nbsp;&nbsp;配信に失敗しました。考えられる理由として<a href="https://help.xoxzo.com/ja/ezsms-sms-delivery-service/sms-api/articles/ezsms-what-does-the-delivery-status-mean/">こちら</a>をご覧ください。</td>
      </tr>
      <tr>
        <td>USED_POINTS</td>
